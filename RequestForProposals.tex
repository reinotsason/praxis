...
due to their long shifts\cite{thestar2012}. This document will introduce
definitions of key terms associated with the problem and the taxi community
in the City of Toronto. Based on the establish context, the needs taxi drivers
experience will be explored and framed into an problem in an engineering perspective. 
...
pain. Avoiding or delaying the onset of chronic pain is an essential 
need which when fulfilled would enhance their work environment of 
a taxi driver.

\subsection{Need}
\label{sec:need}

Need can be defined as innate nutriments that are essential for 
ongoing growth, integrity and well-being\cite{deci2000and}. The 
various needs of taxi drivers will be explored. The 
need for allievating chronic pain experienced by taxi drivers will 
framed in order to achieve an improved quality of life. 
