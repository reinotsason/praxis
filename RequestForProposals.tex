...
\label{sec:intro}
Taxi drivers in the City of Toronto require a solution to the problem of 
chronic pain experienced due to long work shifts. The nature of the taxi 
driver profession, which requires extend periods of driving, makes taxi 
drivers vulnerable to physical discomfort\cite{thestar2012}. Research studies
support this claim by identifying a link between long periods of driving and 
chronic pain\cite{KneePain, Okunribido2008} This document will introduce
