...
\label{sec:scoping}
The scope of the framed engineering problem was to broad for first year 
...
the sole providers of income of the family. 

\subsection{Minor Revisions}
\label{sec:minor revisions} 
Added detailed scoping to abstract for consistency with report 

Inserted further graphics so support report    

Made additional connections between Taxi Driver Association as a
Stakeholder and its support in the development of a solution to alleviate
Lower-back pain among it’s union members 

Expanded economy section of design philosophy to frame taxi drivers and a  community with a median income below the designate Canadian poverty line 
